...
from libs import generateGUI, initCard
...
def play_game():
    ...
    while (True):
        ...
        if command[0] == 'EXIT':
            ...
            command = input('Are you sure to restart the game? Your current progress will be lost! Restart? (Y/N): ')
            ...
            if cache:
                ...
                statement = name + ', you have reached you limit! No more undo!'
